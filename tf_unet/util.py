...
#     """
#     For same padding no cropping!
#     """
#     return data


def crop_to_shape_old(data, shape):
    """
    ...
    # print("cropped.shape = ", cropped.shape, "shape = ", shape)
...
def combine_img_prediction(data, gt, pred):
    ...
    # samarinm adjusted: Use only RGB channels for display
    data = data[...,:3]
